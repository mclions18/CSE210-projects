...
// To exceed requirements, I allowed the user to have to option to put in their own verse to memorize.  The program prompts them for the book, chapter, verse/verses (the program asks if they want to do a multi verse section and will correctly display the reference for multiple verses), and the text of the scripture they want to memorize. It then displays the users scripture to them and allows them to remove words, just like the pre-provided scripture.
class Program
{
